...
export const mapMarkers: MapMarker[] = [
...

  {
    ...
    lng: -118.3798,
    type: "road-closed",
    label: "Laurel Canyon Blvd Closed",
    details: "Brush fire activity and fallen debris between Mulholland Dr and Lookout Mountain Ave",
    roadPath: [
      [34.1192, -118.3821],
      [34.1174, -118.3812],
      [34.1156, -118.3801],
  ...
  },
  {
    ...
    lng: -118.3283,
    type: "road-closed",
    label: "US-101 Southbound Closure",
    details: "CHP hard closure from Cahuenga Blvd to Vermont Ave due to smoke and collision response",
    roadPath: [
      [34.1018, -118.3307],
      [34.0989, -118.3299],
      [34.0960, -118.3292],
  ...
  },
  {
    ...
    lng: -118.2504,
    type: "road-closed",
    label: "I-10 Eastbound Partial Closure",
    details: "Two right lanes closed near Downtown for fire department access and utility repairs",
    roadPath: [
      [34.0435, -118.2661],
      [34.0427, -118.2617],
      [34.0418, -118.2572],
  ...
  },
  {
    ...
    lng: -118.4876,
    type: "road-closed",
    label: "I-405 Northbound Ramp Closure",
    details: "Sepulveda Pass on-ramp closures for emergency staging and air operations",
    roadPath: [
      [34.0459, -118.4950],
      [34.0481, -118.4932],
      [34.0505, -118.4914],
  ...
  },
  {
    ...
    lng: -118.5362,
    type: "road-closed",
    label: "Pacific Coast Hwy Closure",
    details: "PCH closed between Chautauqua Blvd and Carbon Beach Terrace due to active hillside fire",
    roadPath: [
      [34.0384, -118.5443],
      [34.0405, -118.5416],
      [34.0427, -118.5390],
  ...
  },
  {
    ...
    lng: -118.2438,
    type: "road-closed",
    label: "CA-2 / Glendale Fwy Connector Closed",
    details: "NB connector shutdown near Eagle Rock for tanker turnaround and spot-fire containment",
    roadPath: [
      [34.1397, -118.2522],
      [34.1419, -118.2498],
      [34.1441, -118.2473],
